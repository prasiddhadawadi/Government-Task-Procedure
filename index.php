...
//        print_r($values);
        ...
        if (mysqli_num_rows($login) > 0) {
            ...
            $_SESSION['role'] = $login->fetch_assoc()['role_id'];
...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Government Task Procedure</title>
...
<!--                           <option value="Kavreplanchauk">Kavreplanchauk</option>
                       ...
                       <!--    <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <button type="submit" role="submit" name="register" class="btn btn-primary">Submit</button>
                    </form>
                        <ul class="list-inline pull-right">
